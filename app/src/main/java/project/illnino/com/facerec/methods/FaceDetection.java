package project.illnino.com.facerec.methods;
...
public class FaceDetection {
    private static final String TAG = FaceDetection.class.getName();
    public static final Scalar FACE_COLOR = new Scalar(0, 255, 0, 255);
